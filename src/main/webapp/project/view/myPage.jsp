...
<!-- Bootstrap core CSS -->
<link href="/web/project/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
...
<body>
	...
	<div class="container">
		...
		<div class="row my-4">
			...
			<div class="col-lg-12 mb-4">
				<div class="card h-100">
					...
					<div class="card-body">
						...
						<table width="100%" cellspacing="0" border="1" class="tbl_type">
						<colgroup>
							<col width="413">
							<col width="100">
							<col width="120">
                        ...
                        <tr>
                          ...
                          <img id="main" src="/web/upload/" width="400" height="400"/>
                          </td>
							</tr>
								<th scope="row">이름</th>
			...
			<a href="#" class="btn btn-primary" style="float: right;">탈퇴</a>
			<a href="#" class="btn btn-primary" style="float: right;">수정</a>
                        ...
                        <tr>
                          ...
                          <img id="main" src="/web/upload/" width="400" height="400"/>
							...
							<tr>
							<th scope="row">소개글</th>
							<td colspan="3">가나다라마바사 <br> 아자차카타파하</td>
							</tr>
						</tbody>
					</table>
			<a href="#" class="btn btn-primary" style="float: right;">탈퇴</a>
