				...
				<tr>
					<td>
						...
						<div class="input-group">
							...
							<input id="id" type="text" class="form-control" name="email" placeholder="id">
						</div> <br> pw
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock"></i></span>
							<input id="pwid" type="password" class="form-control" name="password" placeholder="Password">
						</div>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock"></i></span>
							<input id="pwcheck" type="password" class="form-control" name="password" placeholder="Passwordcheck">
						</div> <br>
					</td>
				</tr>
			</table>
