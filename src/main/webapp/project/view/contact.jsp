...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <p>
                    <abbr title="Email">E</abbr>: <a href="/web/project/view/mailto:name@example.com">name@example.com
                    </a>
                </p>
                <p>
    ...
    <script src="/web/project/js/jqBootstrapValidation.js"></script>
    <script src="/web/project/js/contact_me.js"></script>
